...
ef_data = sio.loadmat('results/earthformer/Progressive_Data_Ablation_Test/results.mat')
unet_data = sio.loadmat('results/unet/Progressive_Data_Ablation_Test/results.mat')
nwm_data = sio.loadmat('results/neuralwave/Progressive_Data_Ablation_Test/results.mat')
nwm_dynamic_data = sio.loadmat('results/nwm_dynamic/Progressive_Data_Ablation_Test/results.mat')
...
plt.savefig(f'{figures_path}/Figure_4a.tiff', dpi=300, format='tiff', bbox_inches='tight')
