...
if __name__ == "__main__":
    ...
    for model in models[:-1]:
        file_path = f'results/{path_model[model]}/Integrated_Parameters_Ablation_Test/predictions_{idn:.1f}.nc'
    ...
    plt.savefig(f'{figures_path}/Figure_10.tiff', dpi=300, format='tiff', bbox_inches='tight')
    # plt.show()