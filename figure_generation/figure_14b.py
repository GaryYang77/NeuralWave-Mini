...
if __name__ == "__main__":
    ...
    for col_idx, model_name in enumerate(models):
        ...
        file_path = f'results/{path_to_model[model_name]}/Noise_Injected_Robustness_Test/predictions_0.1.nc'
    ...
    plt.savefig(f'{figures_path}/Figure_14b.tiff', dpi=300, format='tiff', bbox_inches='tight')
