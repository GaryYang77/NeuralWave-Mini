...
ef_data = sio.loadmat('results/earthformer/Integrated_Parameters_Ablation_Test/results.mat')
unet_data = sio.loadmat('results/unet/Integrated_Parameters_Ablation_Test/results.mat')
nwm_data = sio.loadmat('results/neuralwave/Integrated_Parameters_Ablation_Test/results.mat')
nwm_dynamic_data = sio.loadmat('results/nwm_dynamic/Integrated_Parameters_Ablation_Test/results.mat')
...
plt.savefig(f'{figures_path}/Figure_12a.tiff', dpi=300, format='tiff', bbox_inches='tight')
