...
if __name__ == '__main__':
    ...
    x = None
    for model in models:
        fpath = f'results/{path_model[model]}/Integrated_Parameters_Ablation_Test/predictions_{idn_str}.nc'
    ...
    plot_param_compare(models, swh_pred_all, swh_true_all, x,
                       ...
                       y_limits=(0.5, 1.0),
                       savepath=f'{figures_path}/Figure_9a.tiff')
    plot_param_compare(models, mwd_pred_all, mwd_true_all, x,
                       sample_steps, 'MWD', 'MWD (°)',
                       y_limits=None,
                       savepath=f'{figures_path}/Figure_9b.tiff')